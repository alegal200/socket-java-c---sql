CREATE TABLE test2 (    test1 VARCHAR ( 50 ) ,	test2 VARCHAR ( 50 ) );
CREATE TABLE activity ( id int AUTO_INCREMENT primary key ,  name VARCHAR ( 50 ) ,	min_age int ,max_age int , max_participant int  );
...
CREATE table date_acty( id int AUTO_INCREMENT primary key ,acti_key int , date_start timestamp , num_min int) ; 
